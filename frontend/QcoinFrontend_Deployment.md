...
4. run docker like this
   ...
   sudo docker run \
     --net=host \
     -v /path/to/QcoinFrontend:/usr/share/QcoinFrontend \
     -v /path/to/QcoinFrontend/docker_qcoin.conf:/etc/nginx/sites-enabled/docker_qcoin.conf \
     -v /path/to/QcoinFrontend/docker_nginx.conf:/etc/nginx/nginx.conf \
     -v /path/to/QcoinFrontend/log:/var/log/nginx \
     -d \
